...
export default function UserDashboardPage() {
  ...
  if (!account) return <main className="min-h-screen bg-rr-radial p-10 text-white">Loading user account...</main>;
    ...
    <main className="min-h-screen bg-rr-radial text-white">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mt-4 grid gap-4">
          {myRequests.length === 0 ? <div className="rr-card rounded-3xl p-6 text-rr-chrome">No matching ride requests yet. For this prototype, use the same name or phone number from your account when submitting a ride request.</div> : null}
